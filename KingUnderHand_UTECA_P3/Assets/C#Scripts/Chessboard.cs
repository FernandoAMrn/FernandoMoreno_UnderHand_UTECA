...
public class Chessboard : MonoBehaviour
{
    ...
    private GameObject GenerateSingleTile(float tileSizeX, float tileSizeY, int x, int y)  // Forma de un solo recuadro.
    {
        ...
        vertices[0] = new Vector2(x * tileSizeX, y * tileSizeY);
        vertices[1] = new Vector2(x * tileSizeX, (y + 1) * tileSizeY);
        vertices[2] = new Vector2((x + 1) * tileSizeX, y * tileSizeY);
        vertices[3] = new Vector2((x + 1) * tileSizeX, (y + 1) * tileSizeY);
